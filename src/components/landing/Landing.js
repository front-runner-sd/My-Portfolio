  ...
  return (
    ...
    <div className='relative right-16 max-md:right-0 max-md:pb-5 '>
       <ul className='flex gap-6 font-bold'>
          ...
          <li className=' text-blue-600 hover:text-blue-800 transition-colors hover:border-b-blue-700 hover:border-b-4  pb-1 max-[450px]:hidden'><a href='https://drive.google.com/uc?export=download&id=1DpzjRhbBaAzNS7v15E5hfQ1_vEd6JRdQ' rel='noreferrer'>Download CV</a></li>
       </ul>
    </div>
      </div>
