  ...
  return (
    <section id='About' className='w-full bg-[#f3f3f3] flex flex-col justify-center items-center'>
      <div className='w-11/12 max-w-6xl'>
        ...
        <div className='basis-[40%] saturate-[1.25] '><img src={image}  alt='Soudip Das' className='w-[22rem] rounded-2xl shadow-xl shadow-slate-600 bg-white  h-[35.8rem] p-1 mt-1'/></div>
